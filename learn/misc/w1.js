...
const LastName = "Mickiewicz";
const FullName = `${FirstName} ${LastName}`; // Using template literals for readability
 ...
 */
let booleanVal = true;
const booleanStrVal = "false"; // This is the string literal "false"
 ...
 */
let booleanVal2 = true;
const booleanStrVal2 = "false";
 ...
 */
let anyVar = 54.3; // 'any' allows assigning any type
 ...
 */
const arrStr = ["abc", "cde", "fgh", "ijk", "asdd23", "asdd234", "asdd623"];
const arrStr2 = ["1abc", "1cde", "1fgh,", "1ijk", "1asdd23", "11133", "111"];
 ...
 */
let userId; // Union type: can be `string` OR `number`
userId = "123";
...
function maxAdjacentDistance(nums) {
    ...
    if (nums.length < 2 || // Array must have at least 2 elements
